  ...
  (html
   [:div
    ...
    [:div
     ...
     " | "
     [:a {:href "/cards.html#!/cpp.ete_1"} "Part 1"]
     " | "
     [:b "Part 2"]]]))
...
- Nice dev workflow: hardly ever restarting FW REPL.
- Tight timelines => P.O. super happy to get actionable delivery nearly every day.

__=> Happy dev, happy client =)__
...
- Where's my batteries included framework?
- Concurrency + full async needs discipline, but rewarding once used to it.
- Full Websocket is good, but going from ReST to WS would have been easier.
  ")
